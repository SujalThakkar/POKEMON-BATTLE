class Form {
  ...
  display(){
    ...
    this.charli.position(displayWidth/2 + 50 , displayHeight/2 );
    this.blast.position(displayWidth/2  - 100, displayHeight/2 + 100);
    this.snor.position(displayWidth/2 - 20 , displayHeight/2 + 180);
    this.pika.position(displayWidth/2 + 60 , displayHeight/2 + 100);
    this.venu.position(displayWidth/2 - 100 , displayHeight/2);
